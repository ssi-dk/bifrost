...
def rule__ariba_plasmidfinder(input, output, sampleComponentObj, log):
    try:
        ...
        # Code to run
        command = "ariba run --force {} {} {} {}".format(database_path, reads[0], reads[1], os.path.join(name, "plasmid"))
