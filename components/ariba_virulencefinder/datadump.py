...
def extract_ariba_virulencefinder_data(sampleComponentObj):
    ...
    grouped_df = df.groupby(["ctg", "#ariba_ref_name", "ref_name", "gene", "var_only", "flag", "reads", "cluster", "ref_len", "var_description", "free_text"])
    ...
    flattened_df = flattened_df.drop(columns=["ref_base_assembled", "pc_ident", "ctg_len", "ctg_cov", "known_var", "var_type", "var_seq_type", "known_var_change", "has_known_var", "ref_ctg_change", "ref_ctg_effect", "ref_start", "ref_end", "ref_nt", "ctg_start", "ctg_end", "ctg_nt", "smtls_total_depth", "smtls_nts", "smtls_nts_depth"])
