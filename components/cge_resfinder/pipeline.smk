...
rule check_requirements:
    ...
    run:
        check_requirements.script__initialization(params.component_file, params.component_file, params.sample_file, params.sample_component_file, output, log.out_file, log.err_file)
