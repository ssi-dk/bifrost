...
# different components (min_read_check v2.0.5, whats_my_species v2.0.5, assemblatron v2.0.5)
...
$BIFROST_PIPELINE_TOOLS/bifrost-min_read_check_2.0.5.sif \
-id $sample._id;
singularity run -B \
$BIFROST_RAW_DATA_MNT,\
$sample.properties.paired_reads.summary.data[0],\
$sample.properties.paired_reads.summary.data[1] \
$BIFROST_PIPELINE_TOOLS/bifrost-whats_my_species_2.0.5.sif \
-id $sample._id;
singularity run -B \
$BIFROST_RAW_DATA_MNT,\
$sample.properties.paired_reads.summary.data[0],\
$sample.properties.paired_reads.summary.data[1] \
$BIFROST_PIPELINE_TOOLS/bifrost-assemblatron_2.0.5.sif \
-id $sample._id;
cd ..;
