...
def script__datadump_resfinder(component_folder, sample):
    ...
    datadump_dict = extract_tsv(
        datadump_dict, component_folder, "ariba_resfinder/report.tsv")

    datadump_dict = extract_tsv(
        datadump_dict, component_folder, "abricate_on_resfinder_from_ariba.tsv")
...
script__datadump_resfinder(snakemake.params.folder, snakemake.params.sample)
