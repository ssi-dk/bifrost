...
rule ariba_resfinder:
    ...
    script:
        os.path.join(os.path.dirname(workflow.snakefile), "scripts/rule__ariba_resfinder.py")
#* Dynamic section: end ****************************************************************************
...
rule datadump:
    ...
    input:
        #* Dynamic section: start ******************************************************************
        rules.ariba_resfinder.output.complete  # Needs to be output of final rule
        #* Dynamic section: end ********************************************************************
    output:
